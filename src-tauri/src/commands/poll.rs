...
#[specta::specta]pub async fn trigger_poll(app: tauri::AppHandle) -> Result<PollResult, String> {
    poll::trigger_poll(app).await
}

#[tauri::command]

#[specta::specta]pub fn get_poll_countdown(state: tauri::State<AppState>) -> i64 {
