export default {
  ...
  'source.placeholder': 'owner/repo 或组织名（GitHub 仓库 / HuggingFace 组织或链接）/ YouTube 频道或链接',
  'source.add': '添加',
  'source.empty': '暂未添加监控源，请在上方输入 GitHub 仓库（owner/repo）、HuggingFace 组织名或 YouTube 频道。',
  ...
  'source.resume': '恢复',
  'source.delete': '删除',
  'source.invalid_url': '请输入有效的 GitHub 仓库（owner/repo 或链接）、HuggingFace 组织名/链接，或 YouTube 频道（链接 / @handle / 频道 ID），如 microsoft/vscode、moonshotai 或 @Fireship',
  ...
  'err.youtube_no_ai': 'YouTube 源不生成 AI 摘要/翻译',
