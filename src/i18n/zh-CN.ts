export default {
  ...
  'source.placeholder': 'owner/repo 或组织名（GitHub 仓库 / HuggingFace 组织或链接）',
  'source.add': '添加',
  'source.empty': '暂未添加监控源，请在上方输入 GitHub 仓库（owner/repo）或 HuggingFace 组织名。',
  ...
  'source.resume': '恢复',
  'source.delete': '删除',
  'source.invalid_url': '请输入有效的 GitHub 仓库（owner/repo 或链接）或 HuggingFace 组织名/链接，如 microsoft/vscode 或 moonshotai',
