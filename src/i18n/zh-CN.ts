export default {
  ...
  'source.placeholder': 'GitHub 仓库地址 (如 https://github.com/microsoft/vscode)',
  'source.add': '添加',
  'source.empty': '暂未添加监控源，请在上方输入 GitHub 仓库地址。',
  'source.enabled': '启用',
  'source.paused': '暂停',
  'source.visit': '访问',
  'source.check': '检查',
  ...
  'source.resume': '恢复',
  'source.delete': '删除',
  'source.invalid_url': '请输入有效的 GitHub 仓库地址，如 https://github.com/microsoft/vscode',
