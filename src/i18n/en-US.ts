export default {
  ...
  'source.placeholder': 'owner/repo or org name (GitHub repo / HuggingFace org or link) / YouTube channel or link',
  'source.add': 'Add',
  'source.empty': 'No sources yet. Add a GitHub repo (owner/repo), HuggingFace org name, or YouTube channel above.',
  ...
  'source.invalid_url': 'Please enter a valid GitHub repo (owner/repo or link), HuggingFace org name/link, or YouTube channel (link, @handle, or channel ID). E.g. microsoft/vscode, moonshotai, or @Fireship',
  ...
  'err.youtube_no_ai': 'YouTube sources are excluded from AI summary/translation',
