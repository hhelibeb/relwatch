export default {
  ...
  'source.placeholder': 'owner/repo or org name (GitHub repo / HuggingFace org or link)',
  'source.add': 'Add',
  'source.empty': 'No sources yet. Add a GitHub repo (owner/repo) or HuggingFace org name above.',
  ...
  'source.invalid_url': 'Please enter a valid GitHub repo (owner/repo or link) or HuggingFace org name/link, e.g. microsoft/vscode or moonshotai',
